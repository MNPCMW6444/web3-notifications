...
import { useGeneralStakeUiData } from '@/hooks/stake/useGeneralStakeUiData';
import { useUserStakeUiData } from '@/hooks/stake/useUserStakeUiData';
import { useModalContext } from '@/hooks/useModal';
import { useWeb3Context } from '@/libs/hooks/useWeb3Context';
import { useRootStore } from '@/store/root';
import { stakeAssetNameFormatted, stakeConfig } from '@/ui-config/stakeConfig';
import { getNetworkConfig } from '@/utils/marketsAndNetworksConfig';
import { STAKE } from '@/utils/mixPanelEvents';
