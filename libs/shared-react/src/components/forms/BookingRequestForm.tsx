...
export const BookingRequestForm = ({
  ...
  const handleChange = (
    ...
    debouncedUpdate(updatedFormState)?.then();
  ...
  const renderDay = (key: string, label: string) =>
        ...
        {formState ? (
          <>
            <Grid
              ...
              columnSpacing={1}
            >
              <Grid item>{renderDay("sun", "Sunday")}</Grid>
              <Grid item>{renderDay("mon", "Monday")}</Grid>
              <Grid item>{renderDay("tues", "Tuesdy")}</Grid>
              <Grid item>{renderDay("wed", "Wednesday")}</Grid>
              <Grid item>{renderDay("thu", "Thursday")}</Grid>
              <Grid item>{renderDay("fri", "Friday")}</Grid>
              <Grid item>{renderDay("sat", "Saturday")}</Grid>
            </Grid>
            <Grid item>
              {renderDatePicker(
                formState,
